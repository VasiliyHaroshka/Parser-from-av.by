...
def parser() -> list:
    """
    Function for parcing models, links, prices and other common information about cars Toyota Land Cruiser Prado from
    ...
    :return: list is contained information that has parsed
    """
...
def to_excel(data: list) -> None:
    """
    Function for write list of data to .xlsx file
    :param data: list is contained information that has parsed
    :return: None
    """
...
def to_json(data: list) -> None:
    """
    Function for write list of data to .json file
    :param data: list is contained information that has parsed
    :return: None
    """
